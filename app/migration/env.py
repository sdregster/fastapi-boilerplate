...
from app.auth.models import Role, User  # noqa
...
def run_migrations_offline() -> None:
    ...
    Engine также допустим здесь. Пропуская создание Engine,
    мы не нуждаемся в доступности DBAPI.
...
async def run_async_migrations() -> None:
    ...
    В этом сценарии нам нужно создать Engine и связать
