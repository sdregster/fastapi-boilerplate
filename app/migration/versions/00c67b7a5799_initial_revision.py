...
def upgrade() -> None:
    ...
    Создает таблицы roles и users, а также заполняет
    таблицу roles начальными данными.
    """
...
def downgrade() -> None:
    ...
    Удаляет таблицы users и roles в обратном порядке
    для корректного удаления внешних ключей.
    """
